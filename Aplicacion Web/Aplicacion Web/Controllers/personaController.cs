...
namespace Aplicacion_Web.Controllers
{
    public class personaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_persona,idTipo_Doc,id_Tipo_Vehiculo,Cedula,Nombre,Apellido,Ced_pers_encontro,Nom_Pers_encontro,Ape_Pers_encontro,Lugar_encontro,Fecha_registro")] persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_persona,idTipo_Doc,id_Tipo_Vehiculo,Cedula,Nombre,Apellido,Ced_pers_encontro,Nom_Pers_encontro,Ape_Pers_encontro,Lugar_encontro,Fecha_registro")] persona persona)
        {
            if (ModelState.IsValid)
            {
